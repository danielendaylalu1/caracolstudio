    ...
    <main className="">
      <div className="HEADER section-header min-h-[100vh] p-4">
        ...
        <div className="HEADERTITLES flex max-[985px]:flex-col max-[985px]:space-x-0 space-y-4 items-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 space-x-8">
          <Link
            href="/"
            className="header-link text-[56px] py-16 text-center min-w-[450px] border border-white font-bold text-white inline-block mt-8"
          >
            DESIGN
          </Link>
          <div className="flex flex-col space-y-4 items-center">
            <Link
              href="/"
              className="header-link text-[56px] py-16 text-center min-w-[450px] border border-white font-bold text-white inline-block"
            >
              FACTORY
            </Link>
            <Link
