...
const page = () => {
  return (
    <div className="overflow-y-scroll no-scrollbar">
      <div className="bg-[#cdc8c9] min-h-[100vh] flex flex-col justify-center space-y-8 px-4 py-16">
        <div className="flex justify-around">
          <div className="flex flex-col space-y-8 py-16">
            ...
            <div className="p-8 bg-white max-w-[800px] flex flex-col space-y-6">
              <Card
      ...
      <div className=" bg-white px-4 py-8 min-h-[50vh] flex justify-center items-center">
